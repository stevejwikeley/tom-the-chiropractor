...
listing, Facebook or Instagram, a friend or a flyer — or "something else" and
type a few words. Every answer arrives in your inbox at `CLINIC_EMAIL` — the
same address the desk-check submissions go to, using the same Resend account,
so there was nothing new to set up.
